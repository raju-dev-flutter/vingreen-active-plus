class ProformaInvoiceModel {
  ...
  ProformaInvoiceModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['Proforma Invoice List'] != null) {
      proformaInvoiceList = <ProformaInvoiceList>[];
      json['Proforma Invoice List'].forEach((v) {
        proformaInvoiceList!.add(ProformaInvoiceList.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (proformaInvoiceList != null) {
      data['Proforma Invoice List'] =
          proformaInvoiceList!.map((v) => v.toJson()).toList();
    }
    if (clientsList != null) {
...
class ProformaInvoiceList {
  ...
  ProformaInvoiceList.fromJson(Map<String, dynamic> json) {
