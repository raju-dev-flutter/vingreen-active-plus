class QuotationModel {
  ...
  QuotationModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['Quotation List'] != null) {
      quotationList = <QuotationList>[];
      json['Quotation List'].forEach((v) {
        quotationList!.add(QuotationList.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (quotationList != null) {
      data['Quotation List'] = quotationList!.map((v) => v.toJson()).toList();
    }
    if (clientsList != null) {
