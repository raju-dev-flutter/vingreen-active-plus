...
class InvoiceAddBloc {
  ...
  Future<void> fetchInvoiceDetailLoaded() async {
    final userId = await userRepositories.hasUserId();
    dynamic response = await invoiceRepositories.fetchInvoiceAddApi(userId);
  ...
  Future<void> uploadInvoiceProductUpdate(BuildContext _,
    ...
    invoiceCrudCubit.uploadInvoiceAddSubmit(
