...
import '../../../logic/rxdart/proforma_invoice/proforma_invoice_add_bloc.dart';
import '../../components/app_loader.dart';
import '../../components/app_toast.dart';

class ProformaInvoiceAddPage extends StatefulWidget {
  static const String id = "proforma_invoice_add_page";

  const ProformaInvoiceAddPage({Key? key}) : super(key: key);

  @override
  State<ProformaInvoiceAddPage> createState() => _ProformaInvoiceAddPageState();
}

class _ProformaInvoiceAddPageState extends State<ProformaInvoiceAddPage> {
  ...
  void initState() {
    ...
    proformaInvoiceCrudCubit.initialProformaInvoiceAddCrud();
    proformaInvoiceAddBloc.fetchProformaInvoiceDetailLoaded();
  }
            ...
            child: Column(
              children: [
                streamBuilderDropdown(
                  label: 'Client Name',
                  streamList: proformaInvoiceAddBloc.clientsList,
                ),
          ...
          return BottomAppBar(
            child: Container(
              ...
              child: state is ProformaInvoiceCrudFromLoading
                  ? showDropdownLoaded()
                  : submitButton(onTap: () {
                      proformaInvoiceAddBloc.uploadProformaInvoiceProductUpdate(
  ...
  appBar(BuildContext context) {
    return AppBar(
      ...
      title: Text('Create New Proforma Invoice',
  ...
  getStreamInitValue(String label) {
    if (label == "Client Name") {
      return proformaInvoiceAddBloc.clientsListInit.valueOrNull?.clientName;
    }
  }
              ...
              if (snapshot.hasData) {
                ...
                return DropDownTextField(
                  ...
                  onChanged: (dynamic val) {
                    if (val != '') {
                      if (label == "Client Name") {
                        proformaInvoiceAddBloc.invoiceClientsList(val.value);
                      }
                    }
        ...
        children: [
          ...
          StreamBuilder<DateTime>(
            stream: label == "Issue Date"
                ? proformaInvoiceAddBloc.dateIssue
                : proformaInvoiceAddBloc.dueDate,
            builder: (context, snapshot) {
              final selectedDate = snapshot.data ?? DateTime.now();
              final selectDate = label == "Issue Date"
                  ? proformaInvoiceAddBloc.seletedDateIssue
                  : proformaInvoiceAddBloc.seletedDueDate;
              return InkWell(
                onTap: () async {
                  ...
                  if (pickedDate != null) {
                    if (label == "Issue Date") {
                      proformaInvoiceAddBloc.selectIssueDate(pickedDate);
                    } else {
                      proformaInvoiceAddBloc.selectDueDate(pickedDate);
                    }
                  }
                },
                child: Container(
  ...
  checkBox() {
    final isSelectGst = proformaInvoiceAddBloc.gstCheckboxValue.valueOrNull;
    return Container(
      height: 50,
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() => proformaInvoiceAddBloc.setGstCheckBoxValue(1));
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.center,
          ...
          InkWell(
            onTap: () {
              setState(() => proformaInvoiceAddBloc.setGstCheckBoxValue(2));
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.center,
        ...
        SizedBox(
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                onChanged: (value) =>
                    proformaInvoiceAddBloc.filterProductList(value),
              ...
              Expanded(
                child: StreamBuilder<List<ProductsList>>(
                    stream: proformaInvoiceAddBloc.filterProduct,
                    builder: (_, snapshot) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                proformaInvoiceAddBloc.filterProductList('');
                                Navigator.pop(context);
                              },
                              child: Container(
