...
import '../../../logic/rxdart/quotation/quotation_add_bloc.dart';
import '../../components/app_loader.dart';
import '../../components/app_toast.dart';

class QuotationAddPage extends StatefulWidget {
  static const String id = "quotation_add_page";
...
class _QuotationAddPageState extends State<QuotationAddPage> {
  ...
  final quotationBloc = QuotationAddBloc();
  ...
  void initState() {
    ...
    quotationBloc.fetchQuotationDetailLoaded();
  }
            ...
            child: Column(
              children: [
                streamBuilderDropdown(
                  label: 'Client Name',
                  streamList: quotationBloc.clientsList,
                ),
          ...
          return BottomAppBar(
            child: Container(
              ...
              child: state is QuotationCrudFromLoading
                  ? showDropdownLoaded()
                  : submitButton(onTap: () {
                      quotationBloc.uploadQuotationProductUpdate(
  ...
  appBar(BuildContext context) {
    return AppBar(
      ...
      title: Text('Create New Quotation',
  ...
  getStreamInitValue(String label) {
    if (label == "Client Name") {
      return quotationBloc.clientsListInit.valueOrNull?.clientName;
    }
  }
              ...
              if (snapshot.hasData) {
                ...
                return DropDownTextField(
                  ...
                  onChanged: (dynamic val) {
                    if (val != '') {
                      if (label == "Client Name") {
                        quotationBloc.quotationClientsList(val.value);
                      }
                    }
        ...
        children: [
          ...
          StreamBuilder<DateTime>(
            stream: label == "Issue Date"
                ? quotationBloc.dateIssue
                : quotationBloc.dueDate,
            builder: (context, snapshot) {
              final selectedDate = snapshot.data ?? DateTime.now();
              final selectDate = label == "Issue Date"
                  ? quotationBloc.seletedDateIssue
                  : quotationBloc.seletedDueDate;
              return InkWell(
                onTap: () async {
                  ...
                  if (pickedDate != null) {
                    if (label == "Issue Date") {
                      quotationBloc.selectIssueDate(pickedDate);
                    } else {
                      quotationBloc.selectDueDate(pickedDate);
                    }
                  }
                },
                child: Container(
  ...
  checkBox() {
    final isSelectGst = quotationBloc.gstCheckboxValue.valueOrNull;
    return Container(
      height: 50,
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() => quotationBloc.setGstCheckBoxValue(1));
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.center,
          ...
          InkWell(
            onTap: () {
              setState(() => quotationBloc.setGstCheckBoxValue(2));
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.center,
      ...
      children: [
        SizedBox(
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                onChanged: (value) => quotationBloc.filterProductList(value),
              ...
              Expanded(
                child: StreamBuilder<List<ProductsList>>(
                    stream: quotationBloc.filterProduct,
                    builder: (_, snapshot) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                quotationBloc.filterProductList('');
                                Navigator.pop(context);
                              },
                              child: Container(
